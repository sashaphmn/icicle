...
namespace ntt_cpu {
  ...
  constexpr uint32_t layers_sub_logn[31][4] = {
    {0, 0, 0, 0},   {1, 0, 0, 0},   {2, 0, 0, 0},   {3, 0, 0, 0},   {4, 0, 0, 0},   {5, 0, 0, 0},   {3, 3, 0, 0},  {4, 3, 0, 0},
    {4, 4, 0, 0},   {5, 4, 0, 0},   {5, 5, 0, 0},   {4, 4, 3, 0},   {4, 4, 4, 0},   {5, 4, 4, 0},   {5, 5, 4, 0},  {5, 5, 5, 0},
    {4, 4, 4, 4},   {5, 4, 4, 4},   {5, 5, 4, 4},   {5, 5, 5, 4},   {5, 5, 5, 5},  {5, 5, 5, 6},  {5, 5, 5, 7}, {5, 5, 5, 8},
    {5, 5, 5, 9}, {5, 5, 5, 10}, {5, 5, 5, 11}, {5, 5, 5, 12}, {5, 5, 5, 13}, {5, 5, 5, 14}, {5, 5, 5, 15}};
